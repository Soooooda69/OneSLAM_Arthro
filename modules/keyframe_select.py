...
class KeyframeSelectFeature(KeyframeSelect):
    ...
    def decide_keyframe(self, idx):
        ...
        if idx == 1:
            ...
            intersection = tracked_point_ids.intersection(last_point_ids)
            intersection_motion = []
            for point_id in intersection:
                last_point = self.slam_structure.last_keyframe.feature.keypoints_info[point_id][0]
                current_point = self.slam_structure.all_frames[idx].feature.keypoints_info[point_id][0]
