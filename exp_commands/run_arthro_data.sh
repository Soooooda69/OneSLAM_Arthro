...
python run_slam.py --data_root $data_root --output_folder $experiment_folder --name h_1_500 --process_subset --start_idx 1 --end_idx 200 \
                    ...
                    #--no_localize #--verbose # --pose_guesser gt_pose --no_localize
