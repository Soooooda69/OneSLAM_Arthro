...
# # h_good_1
python slam.py --data_root $data_root --output_folder $experiment_folder --name test_h --process_subset --start_idx 1 --end_idx 500 \
                    --section_length 4 --past_frame_size 3 --local_ba_size 12 --image_subsample 1 --point_sampler r2d2 --tracked_point_num_min 200 \
